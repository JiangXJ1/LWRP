...
namespace UnityEditor.Rendering.LWRP
{
    ...
    public class LightweightRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static int[] BufferModeValues = new int[]
            {
                int.MaxValue,
                1080,
                720
            ...
            public static string[] BufferModeNames = new string[]
            {
                    "FullScreen",
                    "ScaleTo1080P",
                    "ScaleTo720P"
            ...
            public static GUIContent tempBufferSizeText = EditorGUIUtility.TrTextContent("TempBufferMode", "Set the temporary render buffer size!");
        ...
        SerializedProperty m_TmpBufferMaxSize;
        ...
        void OnEnable()
        {
            ...
            m_TmpBufferMaxSize = serializedObject.FindProperty("m_TmpBufferMaxSize");
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                int value = m_TmpBufferMaxSize.intValue;
                int newValue = EditorGUILayout.IntPopup("Render Buffer Mode", value, Styles.BufferModeNames, Styles.BufferModeValues);
                if(newValue != value)
                {
                    m_TmpBufferMaxSize.intValue = newValue;
                }
